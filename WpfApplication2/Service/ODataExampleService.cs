...
namespace WpfApplication2.Service
{
    ...
    public sealed class ODataExampleService
    {
        ...
        public void SavePaises(IList<Pais> paises)
        {
            if (paises == null)
            {
                return;
        ...
        // OData Batch Processing
        public void UpdatePaises(IList<Pais> paises)
        {
            if (paises == null)
            {
                return;
        ...
        // OData Batch Processing
        public void DeletePaises(IList<Pais> paises)
        {
            if (paises == null)
            {
                return;
        ...
        public bool InsertCountry(Pais pais)
        {
        ...
        public bool UpdateCountry(Pais pais)
        {
        ...
        internal bool DeleteCountry(Pais pais)
        {
